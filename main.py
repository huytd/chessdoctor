...
class ChessDoctor:
    def __init__(self, stockfish_path=None):
        ...
        self.deep_analysis_depth = 22
        self.deep_analysis_time = 1.0  # seconds per position for deep analysis
    ...
    def _get_best_move_and_explanation(self, board, played_move=None):
        ...
        try:
            ...
            return best_move, best_moves, explanation
                ...
                try:
                    ...
                    if move_quality != "good move":
                        ...
                        try:
                            ...
                            best_move, best_score, explanation = self._get_best_move_and_explanation(board_before_move, move)
